"""
The present LSM9DS1 driver for ESP8266 was forked from the LSM9DS1 driver for the pyboard [1]. The porting was done by Aleksei Hemminger in his master thesis of 2017 at the Universitaet der Bundeswehr Munich, Germany.

[1] https://github.com/hoihu/projects/blob/master/raspi-hat/lsm9ds1.py
...
class LSM9DS1:
    ...
    def __init__(self, i2c=None, address_gyro=30, address_magnet=107):
        ...
        self.scratch = bytearray(6) #array.array('B',[0,0,0,0,0,0])
        self.scratch_int = bytearray(3) #array.array('h',[0,0,0])
    ...
    def init_gyro_accel(self, sample_rate=6, scale_gyro=0, scale_accel=0):
        ...
        i2c.writeto_mem(addr, FIFO_CTRL_REG, memoryview(bytearray(1)))
        i2c.writeto_mem(addr, FIFO_CTRL_REG, memoryview(bytearray([6 << 5])))
